...
import com.firechun.dialog.base.action.AnimAction

/**
 * @ClassName CommonDialog
 * @Author panyd
 * @Date 2022/4/27
 * @Description 项目通用 Dialog 布局封装
 */
class CommonDialog {
    ...
    open class Builder<B : Builder<B>>(context: Context) : BaseDialog.Builder<B>(context) {
        ...
        protected val containerLayout: ViewGroup? by lazy { findViewById(R.id.ll_ui_container) }
        ...
        open fun setCustomView(@LayoutRes id: Int): B {
